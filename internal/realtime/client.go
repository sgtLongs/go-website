...
func (c *Client) readPump() {
	...
	for {
		...
		switch command.Type {
		case "start_game", "update_game_settings", "end_game", "confirm_game_start", "confirm_role", "confirm_proposal_result", "propose_quest", "vote_proposal", "play_quest", "assassinate":
